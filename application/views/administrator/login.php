...
<body class="darklayout">
    ...
    <div class="wrapper-pro">
        ...
        <div class="content-inner-all">
            ...
            <!-- Breadcome End-->
            <!-- login Start-->
            <div class="login-form-area mg-t-30 mg-b-40" style="margin-left: -200px;"><br><br><br><br>
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-4"></div>
                        <form id="adminpro-form" class="adminpro-form" method="post" action="<?php echo base_url('administrator/Auth/proses_login')?>">
                            <div class="col-lg-4">
                                <div class="login-bg">
                                    <div class="row">
                                        <div class="col-lg-12">
